...
def estimate_download_size(dataarray, dataarray_selection):
    base_chunk_shape = {key:value[0] for key,value in dataarray.chunksizes.items()}
    ...
    for key in dataarray.chunksizes.keys():
    ...
    estimated_download_shape = {key: base_chunk_shape[key]*needed_chunks_count_by_dim[key] for key in dataarray.chunksizes}
